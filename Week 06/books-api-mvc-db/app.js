...
// UserBook Routes
app.get("/userBooks", userBooksController.getAllUserBooks);
app.post("/userBooks", userBooksController.createUserBook); // POST for creating userBooks (can handle JSON data)
app.get("/userBooks/search", userBooksController.searchUserBooks);
app.get("/userBooks/:id", userBooksController.getUserBookById);
app.put("/userBooks/:id", userBooksController.updateUserBook); // PUT for updating userBooks
app.delete("/userBooks/:id", userBooksController.deleteUserBook); // DELETE for deleting userBooks
